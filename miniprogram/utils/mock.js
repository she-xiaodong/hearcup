...
// 角色：role 1=倾听师 2=咨询师；认证等级 level 1=实习 2=认证 3=资深
...
const providers = [
  {
    ...
    level: 3, levelText: '资深咨询师', rating: 4.9, total_sessions: 1260,
  ...
  },
  {
    ...
    level: 2, levelText: '认证倾听师', rating: 4.8, total_sessions: 540,
  ...
  },
  {
    ...
    level: 2, levelText: '认证倾听师', rating: 4.7, total_sessions: 312,
    price_per_minute: 1.0, is_online: true,
    intro: '程序员转行的倾听师，懂熬夜、懂内耗、懂说不出口的累。慢慢来，不急。',
    expertise: ['职场压力', '焦虑', '社交恐惧']
  },
  {
    id: 1004, role: 2, nickName: '苏晚', avatarColor: '#7AA0FF',
    level: 3, levelText: '资深咨询师', rating: 5.0, total_sessions: 2080,
  ...
  },
  {
    ...
    level: 1, levelText: '实习倾听师', rating: 4.6, total_sessions: 86,
    price_per_minute: 1.0, is_online: true,
  ...
  },
  {
    ...
    level: 2, levelText: '认证倾听师', rating: 4.8, total_sessions: 720,
